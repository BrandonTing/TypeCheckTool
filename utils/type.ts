...
type TypeEffectiveness = Record<Types, Effectiveness>;
type TypeEffectivenessMap = Record<Types, TypeEffectiveness>;
...
// un-used 
// const typeHitEffectivenessMap = types.reduce((pre, curType) => {
//     pre[curType] = types.reduce((prev, curAtkType) => {
//         prev[curAtkType] = typeAttackEffectivenessMap[curAtkType][curType]
//         return prev;
//     }, {} as TypeEffectiveness)
//     return pre
// }, {} as TypeEffectivenessMap)

export function getEffectivenessForType(atkType: Types, defType: Types): Effectiveness {
